...
;Source/Engine/ECS/../Components/sprite_component.h:176: }
	add	sp, #7
	ret
;Source/Engine/ECS/../Components/sprite_component.h:178: static inline void setSpriteOffset(uint8_t entityID, vec2_i newOffset) {
;	---------------------------------
...
_setSpriteOffset:
	...
	ldhl	sp,	#0
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:179: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	e, #0x00
	ld	c, e
00105$:
	ld	a, c
	sub	a, #0x32
	jr	NC, 00107$
;Source/Engine/ECS/../Components/sprite_component.h:180: if (spriteComponent.entityID[i] == entityID) {
	...
	sub	a, b
	jr	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:181: spriteComponent.offset[i] = newOffset;
	ldhl	sp,	#3
	ld	c, l
	ld	b, h
	ld	a, e
	...
	push	hl
	call	___memcpy
;Source/Engine/ECS/../Components/sprite_component.h:182: return;
	jr	00107$
00106$:
;Source/Engine/ECS/../Components/sprite_component.h:179: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	inc	c
	...
	jr	00105$
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:184: }
	inc	sp
	pop	hl
	pop	af
	jp	(hl)
;Source/Engine/ECS/../Components/sprite_component.h:187: static inline bool getSpriteWorldFlag(uint8_t entityID) {
;	---------------------------------
...
;Source/Engine/ECS/../Components/sprite_component.h:189: if (spriteComponent.entityID[i] == entityID)
	...
	sub	a, c
	jr	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:190: return (spriteComponent.flags[i] & SPRF_WORLD) != 0;
	ld	de, #(_spriteComponent + 400)
	ldhl	sp,	#1
	ld	l, (hl)
	ld	h, #0x00
...
;Source/Engine/ECS/../Components/sprite_component.h:188: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	...
	jr	00105$
00103$:
;Source/Engine/ECS/../Components/sprite_component.h:191: return false;
	xor	a, a
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:192: }
	add	sp, #4
	ret
;Source/Engine/ECS/../Components/sprite_component.h:194: static inline void setSpriteWorldFlag(uint8_t entityID, bool isWorld) {
;	---------------------------------
...
_setSpriteWorldFlag:
	...
	ld	(hl), a
	ld	c, e
;Source/Engine/ECS/../Components/sprite_component.h:195: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	b, #0x00
	ld	e, b
00108$:
	ld	a, e
	sub	a, #0x32
	jr	NC, 00110$
;Source/Engine/ECS/../Components/sprite_component.h:196: if (spriteComponent.entityID[i] == entityID) {
	ld	hl, #_spriteComponent
	ld	d, #0x00
	add	hl, de
	ld	d, (hl)
	...
	sub	a, d
	jr	NZ, 00109$
;Source/Engine/ECS/../Components/sprite_component.h:198: spriteComponent.flags[i] |= SPRF_WORLD;
	...
	ld	d, a
	ld	a, (de)
;Source/Engine/ECS/../Components/sprite_component.h:197: if (isWorld)
	bit	0, c
	jr	Z, 00102$
;Source/Engine/ECS/../Components/sprite_component.h:198: spriteComponent.flags[i] |= SPRF_WORLD;
	set	0, a
	...
	jr	00110$
00102$:
;Source/Engine/ECS/../Components/sprite_component.h:200: spriteComponent.flags[i] &= ~SPRF_WORLD;
	res	0, a
	ld	(de), a
;Source/Engine/ECS/../Components/sprite_component.h:201: return;
	jr	00110$
00109$:
;Source/Engine/ECS/../Components/sprite_component.h:195: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	inc	e
	...
	jr	00108$
00110$:
;Source/Engine/ECS/../Components/sprite_component.h:203: }
	inc	sp
	ret
;Source/Engine/ECS/../Components/sprite_component.h:206: static inline bool getSpriteFlipX(uint8_t entityID) {
;	---------------------------------
...
_getSpriteFlipX:
	add	sp, #-4
	ldhl	sp,	#2
;Source/Engine/ECS/../Components/sprite_component.h:207: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	(hl-), a
	xor	a, a
	ld	(hl+), a
	inc	hl
...
00105$:
	...
	sub	a, #0x32
	jr	NC, 00103$
;Source/Engine/ECS/../Components/sprite_component.h:208: if (spriteComponent.entityID[i] == entityID)
	ld	de, #_spriteComponent
	ld	l, (hl)
	ld	h, #0x00
	add	hl, de
	...
	sub	a, c
	jr	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:209: return (spriteComponent.flags[i] & SPRF_FLIPX) != 0;
	ld	de, #(_spriteComponent + 400)
	ldhl	sp,	#1
	ld	l, (hl)
	ld	h, #0x00
...
;Source/Engine/ECS/../Components/sprite_component.h:207: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	...
	jr	00105$
00103$:
;Source/Engine/ECS/../Components/sprite_component.h:210: return false;
	xor	a, a
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:211: }
	add	sp, #4
	ret
;Source/Engine/ECS/../Components/sprite_component.h:213: static inline void setSpriteFlipX(uint8_t entityID, bool flip) {
;	---------------------------------
...
_setSpriteFlipX:
	...
	ld	(hl), a
	ld	c, e
;Source/Engine/ECS/../Components/sprite_component.h:214: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	b, #0x00
	ld	e, b
00108$:
	ld	a, e
	sub	a, #0x32
	jr	NC, 00110$
;Source/Engine/ECS/../Components/sprite_component.h:215: if (spriteComponent.entityID[i] == entityID) {
	ld	hl, #_spriteComponent
	ld	d, #0x00
	add	hl, de
	ld	d, (hl)
	...
	sub	a, d
	jr	NZ, 00109$
;Source/Engine/ECS/../Components/sprite_component.h:217: spriteComponent.flags[i] |= SPRF_FLIPX;
	ld	a, #<((_spriteComponent + 400))
	add	a, b
	ld	e, a
	ld	a, #>((_spriteComponent + 400))
	...
	ld	d, a
	ld	a, (de)
;Source/Engine/ECS/../Components/sprite_component.h:216: if (flip)
	bit	0, c
	jr	Z, 00102$
;Source/Engine/ECS/../Components/sprite_component.h:217: spriteComponent.flags[i] |= SPRF_FLIPX;
	set	1, a
	...
	jr	00110$
00102$:
;Source/Engine/ECS/../Components/sprite_component.h:219: spriteComponent.flags[i] &= ~SPRF_FLIPX;
	res	1, a
	ld	(de), a
;Source/Engine/ECS/../Components/sprite_component.h:220: return;
	jr	00110$
00109$:
;Source/Engine/ECS/../Components/sprite_component.h:214: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	inc	e
	...
	jr	00108$
00110$:
;Source/Engine/ECS/../Components/sprite_component.h:222: }
	inc	sp
	ret
;Source/Engine/ECS/../Components/sprite_component.h:224: static inline bool getSpriteFlipY(uint8_t entityID) {
;	---------------------------------
...
_getSpriteFlipY:
	add	sp, #-4
	ldhl	sp,	#2
;Source/Engine/ECS/../Components/sprite_component.h:225: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	(hl-), a
	xor	a, a
	ld	(hl+), a
	inc	hl
...
00105$:
	...
	sub	a, #0x32
	jr	NC, 00103$
;Source/Engine/ECS/../Components/sprite_component.h:226: if (spriteComponent.entityID[i] == entityID)
	ld	de, #_spriteComponent
	ld	l, (hl)
	ld	h, #0x00
	add	hl, de
	...
	sub	a, c
	jr	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:227: return (spriteComponent.flags[i] & SPRF_FLIPY) != 0;
	ld	de, #(_spriteComponent + 400)
	ldhl	sp,	#1
	ld	l, (hl)
	ld	h, #0x00
...
;Source/Engine/ECS/../Components/sprite_component.h:225: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	...
	jr	00105$
00103$:
;Source/Engine/ECS/../Components/sprite_component.h:228: return false;
	xor	a, a
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:229: }
	add	sp, #4
	ret
;Source/Engine/ECS/../Components/sprite_component.h:231: static inline void setSpriteFlipY(uint8_t entityID, bool flip) {
;	---------------------------------
...
_setSpriteFlipY:
	...
	ld	(hl), a
	ld	c, e
;Source/Engine/ECS/../Components/sprite_component.h:232: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	b, #0x00
	ld	e, b
00108$:
	ld	a, e
	sub	a, #0x32
	jr	NC, 00110$
;Source/Engine/ECS/../Components/sprite_component.h:233: if (spriteComponent.entityID[i] == entityID) {
	ld	hl, #_spriteComponent
	ld	d, #0x00
	add	hl, de
	ld	d, (hl)
	...
	sub	a, d
	jr	NZ, 00109$
;Source/Engine/ECS/../Components/sprite_component.h:235: spriteComponent.flags[i] |= SPRF_FLIPY;
	ld	a, #<((_spriteComponent + 400))
	add	a, b
	ld	e, a
	ld	a, #>((_spriteComponent + 400))
	...
	ld	d, a
	ld	a, (de)
;Source/Engine/ECS/../Components/sprite_component.h:234: if (flip)
	bit	0, c
	jr	Z, 00102$
;Source/Engine/ECS/../Components/sprite_component.h:235: spriteComponent.flags[i] |= SPRF_FLIPY;
	set	2, a
	...
	jr	00110$
00102$:
;Source/Engine/ECS/../Components/sprite_component.h:237: spriteComponent.flags[i] &= ~SPRF_FLIPY;
	res	2, a
	ld	(de), a
;Source/Engine/ECS/../Components/sprite_component.h:238: return;
	jr	00110$
00109$:
;Source/Engine/ECS/../Components/sprite_component.h:232: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	inc	e
	...
	jr	00108$
00110$:
;Source/Engine/ECS/../Components/sprite_component.h:240: }
	inc	sp
	ret
;Source/Engine/ECS/../Components/sprite_component.h:243: static inline bool getSpriteActive(uint8_t entityID) {
;	---------------------------------
...
_getSpriteActive:
	add	sp, #-4
	ldhl	sp,	#2
;Source/Engine/ECS/../Components/sprite_component.h:244: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	(hl-), a
	xor	a, a
	ld	(hl+), a
	inc	hl
...
00105$:
	...
	sub	a, #0x32
	jr	NC, 00103$
;Source/Engine/ECS/../Components/sprite_component.h:245: if (spriteComponent.entityID[i] == entityID)
	ld	de, #_spriteComponent
	ld	l, (hl)
	ld	h, #0x00
	add	hl, de
	...
	sub	a, c
	jr	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:246: return (spriteComponent.flags[i] & SPRF_ACTIVE) != 0;
	ld	de, #(_spriteComponent + 400)
	ldhl	sp,	#1
	ld	l, (hl)
	ld	h, #0x00
...
;Source/Engine/ECS/../Components/sprite_component.h:244: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	...
	jr	00105$
00103$:
;Source/Engine/ECS/../Components/sprite_component.h:247: return false;
	xor	a, a
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:248: }
	add	sp, #4
	ret
;Source/Engine/ECS/../Components/sprite_component.h:250: static inline void setSpriteActive(uint8_t entityID, bool active) {
;	---------------------------------
...
_setSpriteActive:
	...
	ld	(hl), a
	ld	c, e
;Source/Engine/ECS/../Components/sprite_component.h:251: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	ld	b, #0x00
	ld	e, b
00108$:
	ld	a, e
	sub	a, #0x32
	jr	NC, 00110$
;Source/Engine/ECS/../Components/sprite_component.h:252: if (spriteComponent.entityID[i] == entityID) {
	ld	hl, #_spriteComponent
	ld	d, #0x00
	add	hl, de
	ld	d, (hl)
	...
	sub	a, d
	jr	NZ, 00109$
;Source/Engine/ECS/../Components/sprite_component.h:254: spriteComponent.flags[i] |= SPRF_ACTIVE;
	ld	a, #<((_spriteComponent + 400))
	add	a, b
	ld	e, a
	ld	a, #>((_spriteComponent + 400))
	...
	ld	d, a
	ld	a, (de)
;Source/Engine/ECS/../Components/sprite_component.h:253: if (active)
	bit	0, c
	jr	Z, 00102$
;Source/Engine/ECS/../Components/sprite_component.h:254: spriteComponent.flags[i] |= SPRF_ACTIVE;
	set	7, a
	...
	jr	00110$
00102$:
;Source/Engine/ECS/../Components/sprite_component.h:256: spriteComponent.flags[i] &= ~SPRF_ACTIVE;
	res	7, a
	ld	(de), a
;Source/Engine/ECS/../Components/sprite_component.h:257: return;
	jr	00110$
00109$:
;Source/Engine/ECS/../Components/sprite_component.h:251: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	inc	e
	...
	jr	00108$
00110$:
;Source/Engine/ECS/../Components/sprite_component.h:259: }
	inc	sp
	ret
;Source/Engine/ECS/../Components/sprite_component.h:262: static inline LocalSprite getLocalSprite(uint8_t entityID) {
;	---------------------------------
...
_getLocalSprite:
	...
	ldhl	sp,	#15
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:263: LocalSprite s = {0};
	ldhl	sp,	#0
	xor	a, a
	ld	(hl+), a
	ld	(hl+), a
	...
	ld	(hl+), a
	ld	(hl+), a
;Source/Engine/ECS/../Components/sprite_component.h:264: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	xor	a, a
	ld	(hl+), a
	ld	(hl), a
	ld	c, #0x00
00105$:
	...
	sub	a, #0x32
	jp	NC, 00103$
;Source/Engine/ECS/../Components/sprite_component.h:265: if (spriteComponent.entityID[i] == entityID) {
	ld	hl, #_spriteComponent
	ld	b, #0x00
	add	hl, bc
	ld	b, (hl)
	...
	sub	a, b
	jp	NZ, 00106$
;Source/Engine/ECS/../Components/sprite_component.h:266: s.id        = spriteComponent.entityID[i];
	ld	de, #_spriteComponent
	ldhl	sp,	#12
	ld	l, (hl)
	ld	h, #0x00
	...
	ldhl	sp,	#0
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:267: s.width     = spriteComponent.width[i];
	ld	de, #(_spriteComponent + 200)
	ldhl	sp,	#12
	ld	l, (hl)
	ld	h, #0x00
	...
	ldhl	sp,	#1
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:268: s.height    = spriteComponent.height[i];
	ld	de, #(_spriteComponent + 250)
	ldhl	sp,	#12
	ld	l, (hl)
	ld	h, #0x00
	...
	ldhl	sp,	#2
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:269: s.offset    = spriteComponent.offset[i];
	ldhl	sp,	#12
	ld	a, (hl+)
	inc	hl
	add	a, a
	...
	ld	d, h
	call	___memcpy
;Source/Engine/ECS/../Components/sprite_component.h:270: s.flags     = spriteComponent.flags[i];
	ld	de, #(_spriteComponent + 400)
	ldhl	sp,	#12
	ld	l, (hl)
	ld	h, #0x00
	...
	ldhl	sp,	#10
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:271: s.tileData  = spriteComponent.tileData[i];
	...
	ldhl	sp,	#4
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:272: s.tileIndex = spriteComponent.tileIndex[i];
	...
	ldhl	sp,	#5
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:273: s.isWorld   = (spriteComponent.flags[i] & SPRF_WORLD) != 0;
	ld	a, (bc)
	and	a, #0x01
	sub	a, #0x01
	ld	a, #0x00
	...
	xor	a, #0x01
	ldhl	sp,	#8
;Source/Engine/ECS/../Components/sprite_component.h:274: s.visible   = (spriteComponent.flags[i] & SPRF_ACTIVE) != 0;
	ld	(hl+), a
	ld	a, (bc)
	and	a, #0x80
	sub	a, #0x01
	...
	rla
	xor	a, #0x01
;Source/Engine/ECS/../Components/sprite_component.h:275: s.flipProps = spriteComponent.flags[i] & (SPRF_FLIPX | SPRF_FLIPY);
	ld	(hl+), a
	inc	hl
	ld	a, (bc)
	and	a, #0x06
	ld	(hl), a
;Source/Engine/ECS/../Components/sprite_component.h:276: return s;
	ldhl	sp,	#18
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
...
;Source/Engine/ECS/../Components/sprite_component.h:264: for (uint8_t i = 0; i < SPRITE_POOL_SIZE; i++)
	...
	jp	00105$
00103$:
;Source/Engine/ECS/../Components/sprite_component.h:278: return s;
	ldhl	sp,	#18
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	ld	(bc), a
00107$:
;Source/Engine/ECS/../Components/sprite_component.h:279: }
	add	sp, #16
	pop	hl
	pop	af
	jp	(hl)
